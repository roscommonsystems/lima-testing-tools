...
class LimaTestUtils:
    """Core utilities for LIMA regression testing."""
    ...
    # Class-level storage for API keys
    _api_keys = {}
    ...
    def initialize_openrouter_api_key():
        ...
        if LimaTestUtils._api_keys.get('OPEN_ROUTER_API_KEY'):
            return True
        ...
        try:
            ...
            if validation_result.get('valid'):
                ...
                if open_router_api_key_value:
                    # Store in class-level storage for use by other methods
                    LimaTestUtils._api_keys['OPEN_ROUTER_API_KEY'] = open_router_api_key_value
    ...
    def verify_tool_with_screenshots(before_screenshot, after_screenshot, tool_name, verification_prompt):
        ...
        try:
            ...
            LimaTestUtils.initialize_openrouter_api_key()
            
            # Get OpenRouter API key from class-level storage
            open_router_api_key = LimaTestUtils._api_keys.get('OPEN_ROUTER_API_KEY', None)
            ...
            before_base64 = LimaTestUtils.screenshot_to_base64(before_screenshot)
            after_base64 = LimaTestUtils.screenshot_to_base64(after_screenshot)
